  ...
  return (
    <div className="container">
      <div className="frame">
        <div className="nav">
          <ul className="links">
            <li className="signin-active"><CustomLink href="" className="btn">Existing User</CustomLink></li>
            <li className="signup-inactive"><CustomLink href="" className="btn">New User</CustomLink></li>
          </ul>
        </div>
        <div ng-app ng-init="checked = false">
          ...
          <form className="form-signup" action method="post" name="form"> <label htmlFor="fullname">Full name</label> <input className="form-styling" type="text" name="email" placeholder="" />
            ...
            <CustomLink href="" ng-click="checked = !checked" className="btn-signup">REGISTER</CustomLink> </form>
